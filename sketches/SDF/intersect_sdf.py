...
def draw():
    ...
    intersect_sdf_value = max(circle1_sdf_value, circle2_sdf_value)
    ...
    intersect_color = py5.remap(intersect_sdf_value, -1, 1, 0, 255)

    # Draw circles
    py5.stroke(0, intersect_color, 255 - intersect_color)
    ...
    py5.text(
        f"Intersection SDF: {intersect_sdf_value:.2f}", -py5.width / 2 + 10, py5.height / 2 - 20
    )
