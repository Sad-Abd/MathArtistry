...
def draw():
    ...
    # Perform union operation (minimum distance)
    union_sdf_value = min(circle1_sdf_value, circle2_sdf_value)
    ...
    union_color = py5.remap(union_sdf_value, -1, 1, 0, 255)

    # Draw circles
    py5.stroke(0, union_color, 255 - union_color)
    ...
    py5.text(
        f"Union SDF: {union_sdf_value:.2f}", -py5.width / 2 + 10, py5.height / 2 - 20
    )
